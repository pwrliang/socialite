...
public class SingleNodeServer {
  ...
  public SingleNodeServer() {
    ...
    processor.registerProcessor(
        "QueryService", new QueryService.Processor(new QueryHandler(engine)));
    processor.registerProcessor(
        "StandaloneService", new StandaloneService.Processor(new StandaloneServerHandler(this)));
...
class QueryHandler implements QueryService.Iface {
  ...
  public void runSimple(QueryMessage query) throws TException {
    try {
      ...
      SingleNodeServer.L.info(
          "Exception:" + org.apache.commons.lang3.exception.ExceptionUtils.getStackTrace(e));
  ...
  @Override
  public void clear(String table) throws TException {
    try {
  ...
  @Override
  public int getEnumId(String kind, String key) throws TException {
    return EnumId.get(kind, key);
  }

  @Override
  public String getEnumKey(String kind, int id) throws TException {
    return EnumId.get(kind, id);
  }

  @Override
  public List<String> getEnumKeyList(String kind) throws TException {
