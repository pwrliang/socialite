...
public class Loader extends URLClassLoader {
  ...
  static {
    ...
    usePythonLoader = s != null && !s.equalsIgnoreCase("false");
  }
  ...
  public static ClassLoader get() {
    if (usePythonLoader) return imp.getSyspathJavaLoader();
    return theInst;
  }
  ...
  static void addToSysPath(URL url) {
    ...
    if (sys.path.contains(pystr)) return;
    sys.path.add(pystr);
  }
