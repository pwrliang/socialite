...
public class MySTGroupFile extends STGroupFile {
  ...
  public MySTGroupFile(URL resource) {
    this(resource, "UTF-8", '<', '>');
  }

  public MySTGroupFile(
      URL resource, String encoding, char delimiterStartChar, char delimiterStopChar) {
  ...
  @Override
  protected synchronized ST getEmbeddedInstanceOf(
