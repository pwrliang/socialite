...
public class ReflectionUtil {
  ...
  public static Method getCompatiblePublicMethod(
      Class<?> c, String methodName, Class<?>... paramTypes) {
    ...
    if (isOptArgs(paramTypes)) {
      ...
      return getCompatiblePublicMethod(c, methodName, optArgType);
    }
  ...
  public static void main(String[] args) {
    Method m =
        getCompatiblePublicMethod(
            ArgMaxN.class, "add", int.class, Utf8.class, int.class);
