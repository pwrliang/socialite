...
/**
 * This class allows concurrent read access while a single writer updates. If there exist multiple
 * writers, explicit lock is required. {@link "socialite/codegen/DynamicTable.stg"}
 */
public class ConcurrentReadArrayList<E> {
  ...
  public ConcurrentReadArrayList() {
    this(10);
  }
