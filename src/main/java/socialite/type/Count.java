...
public class Count implements Comparable {
  public static boolean invoke(Count a, int b) {
    return a.add(b);
  }

  public static boolean invoke(Count a, long b) {
    return a.add(b);
  }

  public static boolean invoke(Count a, float b) {
    return a.add(b);
  }

  public static boolean invoke(Count a, double b) {
    return a.add(b);
  }

  public static boolean invoke(Count a, Object b) {
    return a.add(b);
  }
