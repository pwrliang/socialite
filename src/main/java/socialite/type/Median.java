...
public class Median {
  public static boolean invoke(Median a, int b) {
    return a.add(b);
  }

  public static boolean invoke(Median a, long b) {
    return a.add(b);
  }

  public static boolean invoke(Median a, float b) {
    return a.add(b);
  }

  public static boolean invoke(Median a, double b) {
    return a.add(b);
  }

  public int getI() {
    return ilist.get(ilist.size() / 2);
  }

  public long getL() {
    return llist.get(llist.size() / 2);
  }

  public float getF() {
    return flist.get(flist.size() / 2);
  }
