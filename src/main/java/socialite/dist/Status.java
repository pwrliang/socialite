...
public class Status {
  ...
  public Object putNodeNum(Object val) {
    return elem.put(NodeNum, val);
  }

  public Object putTableStatus(Object val) {
    return elem.put(Table, val);
  }

  public Object putMemStatus(Object val) {
    return elem.put(FreeMem, val);
  }

  public Object putProgress(Object val) {
    return elem.put(Progress, val);
  }
