...
public class WorkerReqListener implements WorkerRequest {
  ...
  public synchronized void reportIdle(
      IntWritable _epochId, IntWritable _workerId, IntWritable _time) {
        ...
        try {
          ...
          Method isStillIdle =
              WorkerCmd.class.getMethod(
                  "isStillIdle", IntWritable.class, IntWritable.class);
          ...
          Method setEpochDone =
              WorkerCmd.class.getMethod("setEpochDone", IntWritable.class);
  ...
  public void handleError(IntWritable _workerid, IntWritable _ruleid, Text _errorMsg) {
    ...
    try {
      Method halt = WorkerCmd.class.getMethod("haltEpoch");
      Object[] p = new Object[] {};
      MasterNode.callWorkers(halt, p);
    } catch (Exception e) {
