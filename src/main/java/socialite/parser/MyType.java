...
public class MyType {
  public static boolean isPrimNumberType(Class type) {
    Class[] numberTypes =
        new Class[] {int.class, long.class, float.class, double.class, short.class, byte.class};
  ...
  public static String javaObjectTypeName(Class type) {
    if (type.isPrimitive()) {
      if (type.equals(int.class)) return "Integer";
      ...
      else if (type.equals(short.class)) return "Short";
      else if (type.equals(byte.class)) return "Byte";
      else if (type.equals(boolean.class)) return "Boolean";
      else if (type.equals(char.class)) return "Character";
      throw new SociaLiteException("Unexpected primitive type:" + type.getSimpleName());
    }
