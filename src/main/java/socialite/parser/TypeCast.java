...
public class TypeCast extends Op implements UnaryOp {
  ...
  public boolean isValid(Class<?> fromType) {
    ...
    if (fromType.isPrimitive()) {
      return !boolean.class.equals(fromType) && !boolean.class.equals(type);
    } else {
      if (Boolean.class.equals(fromType) || Boolean.class.equals(type)) {
        return false;
      }

      return fromType.isAssignableFrom(type) || type.isAssignableFrom(fromType);
    }
  }
