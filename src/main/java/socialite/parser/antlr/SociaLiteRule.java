...
public class SociaLiteRule extends TreeParser {
  ...
  public String[] getTokenNames() {
    return SociaLiteRule.tokenNames;
  }

  public String getGrammarFileName() {
    return "/Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g";
  }
  ...
  public String maybeGetDuplicateColumnName(List<ColumnDecl> decls) {
    ...
    for (ColumnDecl d : decls) {
      if (names.contains(d.name)) return d.name;
      names.add(d.name);
    }
    return null;
  }
  ...
  Variable getVariable(String name) {
    ...
    if (varMapInRule.containsKey(name)) {
      return varMapInRule.get(name);
    }
  ...
  public Integer getSimpleIntValue(Object o) {
    if (o instanceof Const) {
      Const c = (Const) o;
      if (c.type.equals(Integer.class) || c.type.equals(int.class)) return (Integer) c.val;
    }
  ...
  public Variable addTmpVarAssign(Object rhs) {
    ...
    try {
      tmpVarAssigns.add(new AssignOp(tmpVar, rhs));
  ...
  // $ANTLR start "prog"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:135:1: prog returns [List result] : (
  // stat )+ EOF ;
          ...
          switch (alt1) {
            case 1:
              // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:137:9: stat
              {
                ...
                else retval.result.add((stat1 != null ? stat1.result : null));
              }
              break;
  ...
  // $ANTLR start "stat"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:144:1: stat returns [Object result] :
  // ( table_decl | rule | query | table_stmt );
  public final SociaLiteRule.stat_return stat() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:145:2: ( table_decl | rule | query
      // | table_stmt )
      int alt2 = 4;
      switch (input.LA(1)) {
        case DECL:
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:150:1: table_stmt returns [TableStmt
  // result] : ( ^( CLEAR ID ) | ^( DROP ( ID )? ) );
  public final SociaLiteRule.table_stmt_return table_stmt() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:151:2: ( ^( CLEAR ID ) | ^( DROP (
      // ID )? ) )
      int alt4 = 2;
  ...
  // $ANTLR start "query"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:154:1: query returns [Query result] :
  // ^( QUERY predicate ) ;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:161:1: table_decl returns [TableDecl
  // result] : ^( DECL ID decls ^( OPTION ( table_opts )? ) ) ;
  public final SociaLiteRule.table_decl_return table_decl() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:162:5: ( ^( DECL ID decls ^(
      // OPTION ( table_opts )? ) ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:162:6: ^( DECL ID decls ^( OPTION
      // ( table_opts )? ) )
      {
        root_0 = (CommonTree) adaptor.nil();
          ...
          _last = (CommonTree) input.LT(1);
          {
            ...
            if (input.LA(1) == Token.DOWN) {
              ...
              if ((LA5_0 == CONCURRENT
                  ...
                  || LA5_0 == INDEX_BY
                  || LA5_0 == MULTISET
                  || (LA5_0 >= ORDER_BY && LA5_0 <= PREDEFINED)
                  || (LA5_0 >= SHARD_BY && LA5_0 <= SORT_BY))) {
                alt5 = 1;
              }
              switch (alt5) {
                case 1:
        ...
        String dupCol =
            maybeGetDuplicateColumnName((decls15 != null ? decls15.result : null).getAllColDecls());
        if (dupCol != null)
          throw new ParseException(
              getParser(),
              (ID14 != null ? ID14.getLine() : 0) - 1,
              (ID14 != null ? ID14.getCharPositionInLine() : 0),
              "Duplicate column name " + dupCol + " in " + ID14);
        retval.result =
            new TableDecl(
                (ID14 != null ? ID14.getText() : null),
                (decls15 != null ? decls15.result : null).colDecls,
                (decls15 != null ? decls15.result : null).nestedTable);
          ...
          for (ColumnDecl d : retval.result.nestedTable.getAllColDecls()) {
            if (d.option() instanceof ColIter) {
              throw new ParseException(
                  ...
                  (ID14 != null ? ID14.getLine() : 0) - 1,
                  (ID14 != null ? ID14.getCharPositionInLine() : 0)
                      + (ID14 != null ? ID14.getText() : null).length()
                      + 1,
                  "Iteration column cannot be nested.");
            }
          }
        }
        try {
          retval.result.setOptions((table_opts17 != null ? table_opts17.result : null));
        } catch (ParseException e) {
          e.setLine((ID14 != null ? ID14.getLine() : 0) - 1);
          e.setPos(0);
          e.setParser(getParser());
          throw e;
        }
        if (tableDeclMap.containsKey((ID14 != null ? ID14.getText() : null))) {
          if (!retval.result.equals(tableDeclMap.get((ID14 != null ? ID14.getText() : null)))) {
            throw new ParseException(
                ...
                (ID14 != null ? ID14.getCharPositionInLine() : 0),
                (ID14 != null ? ID14.getText() : null)
                    + " was previously declared with a different signature.");
          }
          retval.result = null;
        } else {
          tableDeclMap.put((ID14 != null ? ID14.getText() : null), retval.result);
        }
      }
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:190:1: table_opts returns
  // [List<TableOpt> result] : opt1= t_opt (opt2= t_opt )* ;
  public final SociaLiteRule.table_opts_return table_opts() throws RecognitionException {
    ...
    try {
      ...
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:191:3: opt1= t_opt (opt2= t_opt )*
      {
        ...
        retval.result = new ArrayList<TableOpt>();
        retval.result.add((opt1 != null ? opt1.result : null));
        ...
        do {
          ...
          if ((LA6_0 == CONCURRENT
              ...
              || LA6_0 == INDEX_BY
              || LA6_0 == MULTISET
              || (LA6_0 >= ORDER_BY && LA6_0 <= PREDEFINED)
              || (LA6_0 >= SHARD_BY && LA6_0 <= SORT_BY))) {
            alt6 = 1;
          }
  ...
  // $ANTLR start "t_opt"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:194:1: t_opt returns [TableOpt result]
  // : ( ^( SORT_BY col= ID (order= SORT_ORDER )? ) | ^( ORDER_BY ID ) | ^( INDEX_BY ID ) | ^(
  // GROUP_BY INT ) | ^( SHARD_BY ID ) | PREDEFINED | CONCURRENT | MULTISET );
  public final SociaLiteRule.t_opt_return t_opt() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:195:2: ( ^( SORT_BY col= ID
      // (order= SORT_ORDER )? ) | ^( ORDER_BY ID ) | ^( INDEX_BY ID ) | ^( GROUP_BY INT ) | ^(
      // SHARD_BY ID ) | PREDEFINED | CONCURRENT | MULTISET )
      int alt8 = 8;
      switch (input.LA(1)) {
        case SORT_BY:
          {
      ...
      switch (alt8) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:195:3: ^( SORT_BY col= ID
          // (order= SORT_ORDER )? )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            _last = (CommonTree) input.LT(1);
            {
              ...
              switch (alt7) {
                case 1:
                  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:195:21: order=
                  // SORT_ORDER
                  {
                    _last = (CommonTree) input.LT(1);
            ...
            if ((order != null ? order.getText() : null) == null)
              retval.result = new SortBy((col != null ? col.getText() : null));
            else if ((order != null ? order.getText() : null).equals("asc"))
              retval.result = new SortBy((col != null ? col.getText() : null));
  ...
  // $ANTLR start "decls"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:208:1: decls returns [NestedTableDecl
  // result] : ^( COL_DECLS col_decls ^( DECL (nested= decls )? ) ) ;
  public final SociaLiteRule.decls_return decls() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:209:2: ( ^( COL_DECLS col_decls ^(
      // DECL (nested= decls )? ) ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:209:3: ^( COL_DECLS col_decls ^(
      // DECL (nested= decls )? ) )
      {
        root_0 = (CommonTree) adaptor.nil();
        ...
        retval.result =
            new NestedTableDecl(
                (col_decls31 != null ? col_decls31.result : null),
                (nested != null ? nested.result : null));
      }
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:212:1: col_decls returns
  // [List<ColumnDecl> result] : d1= col_decl (d2= col_decl )* ;
  public final SociaLiteRule.col_decls_return col_decls() throws RecognitionException {
    ...
    try {
      ...
      // )*
      {
        ...
        retval.result = new ArrayList<ColumnDecl>();
        retval.result.add((d1 != null ? d1.result : null));
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:216:1: col_decl returns [ColumnDecl
  // result] : ^( COL_DECL type ID ( col_opt )? ) ;
  public final SociaLiteRule.col_decl_return col_decl() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:217:2: ( ^( COL_DECL type ID (
      // col_opt )? ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:217:4: ^( COL_DECL type ID (
      // col_opt )? )
      {
        root_0 = (CommonTree) adaptor.nil();
        ...
        if ((col_opt36 != null ? col_opt36.result : null) instanceof ColRange
          ...
          if ((type34 != null ? type34.result : null) != int.class
              && (type34 != null ? type34.result : null) != long.class) {
            throw new ParseException(
                getParser(),
                (ID35 != null ? ID35.getLine() : 0) - 1,
                (ID35 != null ? ID35.getCharPositionInLine() : 0),
        ...
        retval.result =
            new ColumnDecl(
                (type34 != null ? type34.result : null),
                (ID35 != null ? ID35.getText() : null),
                (col_opt36 != null ? col_opt36.result : null));
      }
  ...
  // $ANTLR start "col_opt"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:230:1: col_opt returns [ColOpt result]
  // : ( ^( RANGE i1= INT i2= INT ) | ITER | ^( BIT i1= INT ) );
  public final SociaLiteRule.col_opt_return col_opt() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:231:2: ( ^( RANGE i1= INT i2= INT
      // ) | ITER | ^( BIT i1= INT ) )
      int alt12 = 3;
      switch (input.LA(1)) {
        case RANGE:
      ...
      switch (alt12) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:231:3: ^( RANGE i1= INT i2=
          // INT )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            retval.result =
                new ColRange(
                    Integer.parseInt((i1 != null ? i1.getText() : null)),
                    Integer.parseInt((i2 != null ? i2.getText() : null)));
          }
          break;
        case 2:
  ...
  // $ANTLR start "type"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:241:1: type returns [Class result] : (
  ...
  public final SociaLiteRule.type_return type() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:242:2: ( 'int' ( '[' ']' )? |
      ...
      switch (alt20) {
        ...
        case 7:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:248:4: ID ( '[' ']' )?
          {
            ...
            try {
              retval.result = Class.forName(fullname);
            } catch (ClassNotFoundException e) {
              throw new ParseException(
                  getParser(),
                  (ID58 != null ? ID58.getLine() : 0) - 1,
                  (ID58 != null ? ID58.getCharPositionInLine() : 0),
                  "Class " + fullname + " cannot be resolved");
            }
  ...
  // $ANTLR start "rule"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:257:1: rule returns [Object result] :
  ...
  public final SociaLiteRule.rule_return rule() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:258:9: ( ( ^( RULE head litlist )
      // )+ DOT_END )
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:258:10: ( ^( RULE head litlist )
      // )+ DOT_END
      {
        root_0 = (CommonTree) adaptor.nil();
        ...
        do {
          ...
          switch (alt21) {
            case 1:
              // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:261:11: ^( RULE head
              // litlist )
              {
                _last = (CommonTree) input.LT(1);
                {
                ...
                if (first == null) {
                  ...
                  body =
                      (litlist63 != null ? litlist63.result : null)
                          .subList(
                              first.size(), (litlist63 != null ? litlist63.result : null).size());
                }
  ...
  // $ANTLR start "head"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:281:1: head returns [Predicate result]
  // : predicate ;
  ...
  // $ANTLR start "litlist"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:290:1: litlist returns [List<Literal>
  // result] :l1= literal (l2= literal )* ;
    ...
    try {
      ...
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:291:4: l1= literal (l2= literal )*
      {
        ...
        if ((l1 != null ? l1.result : null) instanceof List) {
          for (Literal o : (List<Literal>) (l1 != null ? l1.result : null)) retval.result.add(o);
        } else {
          retval.result.add((Literal) ((l1 != null ? l1.result : null)));
        }
            ...
            case 1:
              // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:308:3: l2= literal
              {
                ...
                if ((l2 != null ? l2.result : null) instanceof List) {
                  ...
                  retval.result.add((Literal) (l2 != null ? l2.result : null));
                }
              }
              break;
  ...
  // $ANTLR start "literal"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:325:1: literal returns [Object result]
  // : ( ^( PREDICATE ( NOT )? predicate ) | ^( EXPR expr ) );
  public final SociaLiteRule.literal_return literal() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:326:2: ( ^( PREDICATE ( NOT )?
      // predicate ) | ^( EXPR expr ) )
      int alt24 = 2;
      ...
      switch (alt24) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:326:3: ^( PREDICATE ( NOT )?
          // predicate )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            if (!tmpVarAssigns.isEmpty()) {
              retval.result = new ArrayList<Literal>();
              for (AssignOp op : tmpVarAssigns) ((List<Literal>) retval.result).add(new Expr(op));
              ((List<Literal>) retval.result)
                  .add((predicate68 != null ? predicate68.result : null));
              tmpVarAssigns.clear();
            }
          }
          break;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:350:1: predicate returns [Predicate
  // result] : ID paramlist ;
    ...
    try {
      ...
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:351:4: ID paramlist
      {
        ...
        if (decl == null) {
          throw new ParseException(
              getParser(),
              (ID71 != null ? ID71.getLine() : 0) - 1,
              (ID71 != null ? ID71.getCharPositionInLine() : 0),
              "Table " + (ID71 != null ? ID71.getText() : null) + " is not declared");
        } else {
          try {
        ...
        retval.result =
            new Predicate(
                (ID71 != null ? ID71.getText() : null),
                (paramlist72 != null ? paramlist72.result : null));
      }
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:365:1: function returns [Function
  // result] : ^( FUNC dotname ( fparamlist )? ) ;
  public final SociaLiteRule.function_return function() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:366:2: ( ^( FUNC dotname (
      // fparamlist )? ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:366:4: ^( FUNC dotname (
      // fparamlist )? )
      {
        root_0 = (CommonTree) adaptor.nil();
        ...
        retval.result =
            new Function(
                (dotname74 != null ? dotname74.result : null),
                (fparamlist75 != null ? fparamlist75.result : null));
      }
  ...
  // $ANTLR start "param"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:370:1: param returns [Object result] :
  // simpleExpr ;
      ...
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:371:4: simpleExpr
      {
        ...
        if (tmpVarAssignHasFunc()) {
          throw new ParseException(
              ...
              (simpleExpr76 != null ? ((CommonTree) simpleExpr76.tree) : null)
        ...
        if ((simpleExpr76 != null ? simpleExpr76.result : null) instanceof Function) {
          retval.result =
              new AggrFunction((Function) (simpleExpr76 != null ? simpleExpr76.result : null));
        }
      }
  ...
  // $ANTLR start "fparam"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:392:1: fparam returns [Object result]
  // : simpleExpr ;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:395:1: paramlist returns [List<Param>
  // result] :p1= param (p2= param )* ;
    ...
    try {
      ...
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:396:3: p1= param (p2= param )*
      {
        ...
        if (isSimpleIntValue((p1 != null ? p1.result : null))) {
          retval.result.add(
              new Const(getSimpleIntValue((p1 != null ? p1.result : null)), getNextConstId()));
        } else if (((p1 != null ? p1.result : null) instanceof BinOp)
            || ((p1 != null ? p1.result : null) instanceof UnaryOp)) {
          ...
          throw new ParseException(
              getParser(),
              (p1 != null ? ((CommonTree) p1.tree) : null).getLine() - 1,
              (p1 != null ? ((CommonTree) p1.tree) : null).getCharPositionInLine() + 1,
              "Cannot use " + (p1 != null ? p1.result : null) + " in parameter list");
        } else {
          retval.result.add((Param) ((p1 != null ? p1.result : null)));
        }
            ...
            case 1:
              // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:409:3: p2= param
              {
                ...
                if (isSimpleIntValue((p2 != null ? p2.result : null))) {
                  retval.result.add(
                      new Const(
                          getSimpleIntValue((p2 != null ? p2.result : null)), getNextConstId()));
                } else if (((p2 != null ? p2.result : null) instanceof BinOp)
                    || ((p2 != null ? p2.result : null) instanceof UnaryOp)) {
                  Variable tmpVar = addTmpVarAssign((p2 != null ? p2.result : null));
                  retval.result.add(tmpVar);
                } else if ((p2 != null ? p2.result : null) instanceof Op) {
                  throw new ParseException(
                      getParser(),
                      (p2 != null ? ((CommonTree) p2.tree) : null).getLine() - 1,
                      (p2 != null ? ((CommonTree) p2.tree) : null).getCharPositionInLine() + 1,
                      "Cannot use " + (p2 != null ? p2.result : null) + " in parameter list");
                } else {
                  retval.result.add((Param) ((p2 != null ? p2.result : null)));
                }
              }
              break;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:423:1: fparamlist returns [List<Param>
  // result] :p1= fparam (p2= fparam )* ;
  public final SociaLiteRule.fparamlist_return fparamlist() throws RecognitionException {
    ...
    try {
      ...
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:424:3: p1= fparam (p2= fparam )*
      {
        ...
        if (((p1 != null ? p1.result : null) instanceof BinOp)
            || ((p1 != null ? p1.result : null) instanceof UnaryOp)
            || ((p1 != null ? p1.result : null) instanceof Function)) {
          Variable tmpVar = addTmpVarAssign((p1 != null ? p1.result : null));
          retval.result.add(tmpVar);
        } else if ((p1 != null ? p1.result : null) instanceof Op) {
          throw new ParseException(
          ...
          switch (alt27) {
            case 1:
              // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:435:3: p2= fparam
              {
                ...
                if (((p2 != null ? p2.result : null) instanceof BinOp)
                    || ((p2 != null ? p2.result : null) instanceof UnaryOp)
                    || ((p2 != null ? p2.result : null) instanceof Function)) {
                  Variable tmpVar = addTmpVarAssign((p2 != null ? p2.result : null));
                  retval.result.add(tmpVar);
                } else if ((p2 != null ? p2.result : null) instanceof Op) {
                  throw new ParseException(
  ...
  // $ANTLR start "term"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:448:1: term returns [Object result] :
  // ( ^( T_INT INT ) | ^( T_FLOAT FLOAT ) | ^( T_STR STRING ) | ^( T_UTF8 UTF8 ) | ^( T_VAR dotname
  // ) );
  public final SociaLiteRule.term_return term() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:449:2: ( ^( T_INT INT ) | ^(
      // T_FLOAT FLOAT ) | ^( T_STR STRING ) | ^( T_UTF8 UTF8 ) | ^( T_VAR dotname ) )
      int alt28 = 5;
      switch (input.LA(1)) {
        case T_INT:
          {
      ...
      switch (alt28) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:449:3: ^( T_INT INT )
          {
            ...
            if ((INT79 != null ? INT79.getText() : null).endsWith("l")
                || (INT79 != null ? INT79.getText() : null).endsWith("L")) {
              Long v =
                  new Long(
                      Long.parseLong(
                          (INT79 != null ? INT79.getText() : null)
                              .substring(
                                  0, (INT79 != null ? INT79.getText() : null).length() - 1)));
        ...
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:457:6: ^( T_FLOAT FLOAT )
          {
            ...
            if ((FLOAT81 != null ? FLOAT81.getText() : null).endsWith("f")
                || (FLOAT81 != null ? FLOAT81.getText() : null).endsWith("F")) {
              Float v =
                  new Float(
                      Float.parseFloat(
                          (FLOAT81 != null ? FLOAT81.getText() : null)
                              .substring(
                                  0, (FLOAT81 != null ? FLOAT81.getText() : null).length() - 1)));
              retval.result = new Const(v, getNextConstId());
            } else if ((FLOAT81 != null ? FLOAT81.getText() : null).endsWith("d")
                || (FLOAT81 != null ? FLOAT81.getText() : null).endsWith("D")) {
              Double v =
                  new Double(
                      Double.parseDouble(
                          (FLOAT81 != null ? FLOAT81.getText() : null)
              ...
              Double v =
                  new Double(Double.parseDouble((FLOAT81 != null ? FLOAT81.getText() : null)));
              retval.result = new Const(v, getNextConstId());
            }
          }
          break;
        case 3:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:469:3: ^( T_STR STRING )
          {
            ...
            String v =
                new String(
                    (STRING83 != null ? STRING83.getText() : null)
                        .substring(1, (STRING83 != null ? STRING83.getText() : null).length() - 1));
            retval.result = new Const(v, getNextConstId());
          }
          break;
        case 4:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:470:3: ^( T_UTF8 UTF8 )
          {
            ...
            Utf8 v =
                new Utf8(
                    (UTF885 != null ? UTF885.getText() : null)
                        .substring(2, (UTF885 != null ? UTF885.getText() : null).length() - 1));
            retval.result = new Const(v, getNextConstId());
          }
          break;
        case 5:
  ...
  // $ANTLR start "expr"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:477:1: expr returns [Object result] :
  // ( ^(cmpStr= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) e1= simpleExpr e2= simpleExpr ) | ^(eq=
  // '=' e1= simpleExpr e2= simpleExpr ) | ^( MULTI_ASSIGN varlist function (c= cast )? ) );
  public final SociaLiteRule.expr_return expr() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:478:2: ( ^(cmpStr= ( '<' | '<=' |
      // '>' | '>=' | '==' | '!=' ) e1= simpleExpr e2= simpleExpr ) | ^(eq= '=' e1= simpleExpr e2=
      // simpleExpr ) | ^( MULTI_ASSIGN varlist function (c= cast )? ) )
      int alt30 = 3;
      switch (input.LA(1)) {
        case 56:
        case 69:
      ...
      switch (alt30) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:478:3: ^(cmpStr= ( '<' | '<='
          // | '>' | '>=' | '==' | '!=' ) e1= simpleExpr e2= simpleExpr )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            _last = (CommonTree) input.LT(1);
            {
              ...
              if (input.LA(1) == 56
                  || (input.LA(1) >= 69 && input.LA(1) <= 70)
                  || (input.LA(1) >= 72 && input.LA(1) <= 74)) {
                input.consume();
            ...
            try {
              retval.result =
                  new CmpOp(
                      (cmpStr != null ? cmpStr.getText() : null),
                      (e1 != null ? e1.result : null),
                      (e2 != null ? e2.result : null));
            } catch (InternalException e) {
              throw new ParseException(
                  getParser(),
                  (cmpStr != null ? cmpStr.getLine() : 0) - 1,
                  (cmpStr != null ? cmpStr.getCharPositionInLine() : 0) + 1,
                  e.getMessage());
            }
          }
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:483:5: ^(eq= '=' e1=
          // simpleExpr e2= simpleExpr )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            if (!((e1 != null ? e1.result : null) instanceof Variable)) {
              throw new ParseException(
                  getParser(),
                  (eq != null ? eq.getLine() : 0) - 1,
                  (eq != null ? eq.getCharPositionInLine() : 0) + 1,
                  "Invalid assignment to " + (e1 != null ? e1.result : null));
            }
            TypeCast cast = null;
            ...
            try {
              retval.result = new AssignOp(a1, cast, a2);
            } catch (InternalException e) {
              throw new ParseException(
                  getParser(),
                  (eq != null ? eq.getLine() : 0) - 1,
          ...
          break;
        case 3:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:498:6: ^( MULTI_ASSIGN varlist
          // function (c= cast )? )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            _last = (CommonTree) input.LT(1);
            {
              ...
              _last = (CommonTree) input.LT(1);
              MULTI_ASSIGN88 =
                  (CommonTree) match(input, MULTI_ASSIGN, FOLLOW_MULTI_ASSIGN_in_expr980);
            ...
            try {
              ...
              if ((c != null ? c.result : null) != null) {
                int line = (c != null ? ((CommonTree) c.tree) : null).getLine() - 1,
                    pos = (c != null ? ((CommonTree) c.tree) : null).getCharPositionInLine() + 1;
                throw new ParseException(getParser(), line, pos, "Invalid type cast");
              }
              retval.result =
                  new AssignOp(
                      (varlist89 != null ? varlist89.result : null),
                      typecast,
                      (function90 != null ? function90.result : null));
            } catch (InternalException e) {
              int line = (varlist89 != null ? ((CommonTree) varlist89.tree) : null).getLine() - 1,
                  pos =
                      (varlist89 != null ? ((CommonTree) varlist89.tree) : null)
                              .getCharPositionInLine()
                          + 1;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:511:1: simpleExpr returns [Object
  // result] : ( multExpr | ^(op= ( '+' | '-' ) e1= simpleExpr e2= simpleExpr ) );
  public final SociaLiteRule.simpleExpr_return simpleExpr() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:512:2: ( multExpr | ^(op= ( '+' |
      // '-' ) e1= simpleExpr e2= simpleExpr ) )
      int alt31 = 2;
      int LA31_0 = input.LA(1);

      if ((LA31_0 == COMPOUND_EXPR
          || LA31_0 == FUNCTION
          || LA31_0 == TERM
          || LA31_0 == 60
          || LA31_0 == 65
      ...
      switch (alt31) {
        case 1:
          ...
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:513:3: ^(op= ( '+' | '-' ) e1=
          // simpleExpr e2= simpleExpr )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            try {
              retval.result = new BinOp((op != null ? op.getText() : null), arg1, arg2);
            } catch (InternalException e) {
              throw new ParseException(
                  getParser(),
                  (op != null ? op.getLine() : 0) - 1,
                  (op != null ? op.getCharPositionInLine() : 0) + 1,
                  e.getMessage());
            }
          }
          break;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:523:1: multExpr returns [Object
  // result] : ( exprValue | ^(op= ( '*' | '/' | 'mod' ) v1= multExpr v2= multExpr ) );
  public final SociaLiteRule.multExpr_return multExpr() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:524:2: ( exprValue | ^(op= ( '*' |
      // '/' | 'mod' ) v1= multExpr v2= multExpr ) )
      int alt32 = 2;
      ...
      switch (alt32) {
        case 1:
          ...
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:525:3: ^(op= ( '*' | '/' |
          // 'mod' ) v1= multExpr v2= multExpr )
          {
            root_0 = (CommonTree) adaptor.nil();
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:535:1: compExpr returns [Object
  // result] : e1= simpleExpr ;
  ...
  // $ANTLR start "varlist"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:538:1: varlist returns [Object result]
  // : id1= dotname (id2= dotname )+ ;
  public final SociaLiteRule.varlist_return varlist() throws RecognitionException {
    ...
    try {
      ...
      // )+
      {
        ...
        vars.add(getVariable((id1 != null ? id1.result : null)));
        retval.result = vars;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:545:1: exprValue returns [Object
  // result] : ( ^( TERM term (neg= '-' )? (c= cast )? ) | ^( FUNCTION function (c= cast )? ) | ^(
  ...
  public final SociaLiteRule.exprValue_return exprValue() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:546:2: ( ^( TERM term (neg= '-' )?
      // (c= cast )? ) | ^( FUNCTION function (c= cast )? ) | ^( COMPOUND_EXPR compExpr (c= cast )?
      // ) )
      int alt38 = 3;
      switch (input.LA(1)) {
        case TERM:
      ...
      switch (alt38) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:546:3: ^( TERM term (neg= '-'
          // )? (c= cast )? )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            if ((neg != null ? neg.getText() : null) != null) {
              if ((term94 != null ? term94.result : null) instanceof Const) {
                ...
                try {
                  retval.result = new UnaryMinus(retval.result);
                } catch (InternalException e) {
                  throw new ParseException(
                      getParser(),
                      (neg != null ? neg.getLine() : 0) - 1,
                      (neg != null ? neg.getCharPositionInLine() : 0) + 1,
                      e.getMessage());
                }
              }
            }
          ...
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:563:3: ^( FUNCTION function
          // (c= cast )? )
          {
            root_0 = (CommonTree) adaptor.nil();
          ...
          break;
        case 3:
          // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:571:3: ^( COMPOUND_EXPR
          // compExpr (c= cast )? )
          {
            root_0 = (CommonTree) adaptor.nil();
            ...
            _last = (CommonTree) input.LT(1);
            {
              ...
              _last = (CommonTree) input.LT(1);
              COMPOUND_EXPR97 =
                  (CommonTree) match(input, COMPOUND_EXPR, FOLLOW_COMPOUND_EXPR_in_exprValue1160);
  ...
  // $ANTLR start "cast"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:579:1: cast returns [Class result] :
  // type ;
  ...
  // $ANTLR start "dotname"
  // /Users/jiwon/workspace/socialite/grammar/SociaLiteRule.g:582:1: dotname returns [String result]
  // : ID ( DOT_ID )* ;
  ...
  public static final BitSet FOLLOW_table_decl_in_stat93 =
  ...
  public static final BitSet FOLLOW_table_stmt_in_stat110 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_CLEAR_in_table_stmt127 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_table_stmt129 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_DROP_in_table_stmt138 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_table_stmt140 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_QUERY_in_query158 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_predicate_in_query160 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_DECL_in_table_decl180 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_table_decl182 =
      new BitSet(new long[] {0x0000000000000200L});
  public static final BitSet FOLLOW_decls_in_table_decl184 =
      new BitSet(new long[] {0x0000000800000000L});
  public static final BitSet FOLLOW_OPTION_in_table_decl187 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_table_opts_in_table_decl189 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_t_opt_in_table_opts223 =
      new BitSet(new long[] {0x0000183088801002L});
  public static final BitSet FOLLOW_t_opt_in_table_opts231 =
      new BitSet(new long[] {0x0000183088801002L});
  public static final BitSet FOLLOW_SORT_BY_in_t_opt250 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_t_opt254 = new BitSet(new long[] {0x0000200000000008L});
  public static final BitSet FOLLOW_SORT_ORDER_in_t_opt259 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_ORDER_BY_in_t_opt269 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_t_opt271 = new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_INDEX_BY_in_t_opt279 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_t_opt281 = new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_GROUP_BY_in_t_opt289 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_t_opt291 = new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_SHARD_BY_in_t_opt299 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_t_opt301 = new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_PREDEFINED_in_t_opt309 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_CONCURRENT_in_t_opt316 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_MULTISET_in_t_opt323 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_COL_DECLS_in_decls340 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_col_decls_in_decls342 =
  ...
  public static final BitSet FOLLOW_decls_in_decls349 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_col_decl_in_col_decls369 =
      new BitSet(new long[] {0x0000000000000102L});
  public static final BitSet FOLLOW_col_decl_in_col_decls378 =
      new BitSet(new long[] {0x0000000000000102L});
  public static final BitSet FOLLOW_COL_DECL_in_col_decl399 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_type_in_col_decl401 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_ID_in_col_decl403 =
      new BitSet(new long[] {0x0000020020000028L});
  public static final BitSet FOLLOW_col_opt_in_col_decl405 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_RANGE_in_col_opt423 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_col_opt427 =
      new BitSet(new long[] {0x0000000010000000L});
  public static final BitSet FOLLOW_INT_in_col_opt431 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_ITER_in_col_opt439 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_BIT_in_col_opt447 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_col_opt451 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_88_in_type467 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type472 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type474 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_89_in_type485 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type489 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type491 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_85_in_type500 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type505 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type507 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_83_in_type517 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type522 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type524 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_77_in_type534 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type539 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type541 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_76_in_type551 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type555 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type557 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_type568 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type573 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  ...
  public static final BitSet FOLLOW_litlist_in_rule618 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_DOT_END_in_rule626 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_predicate_in_head653 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_literal_in_litlist677 =
      new BitSet(new long[] {0x0000004000080002L});
  public static final BitSet FOLLOW_literal_in_litlist686 =
      new BitSet(new long[] {0x0000004000080002L});
  public static final BitSet FOLLOW_PREDICATE_in_literal704 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_NOT_in_literal706 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_predicate_in_literal709 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_EXPR_in_literal716 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_literal718 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_ID_in_predicate736 =
      new BitSet(new long[] {0xB000800000400800L, 0x0000000004000002L});
  public static final BitSet FOLLOW_paramlist_in_predicate738 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_FUNC_in_function759 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_dotname_in_function761 =
      new BitSet(new long[] {0xB000800000400808L, 0x0000000004000002L});
  public static final BitSet FOLLOW_fparamlist_in_function763 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_simpleExpr_in_param781 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_simpleExpr_in_fparam795 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_param_in_paramlist814 =
      new BitSet(new long[] {0xB000800000400802L, 0x0000000004000002L});
  public static final BitSet FOLLOW_param_in_paramlist822 =
      new BitSet(new long[] {0xB000800000400802L, 0x0000000004000002L});
  public static final BitSet FOLLOW_fparam_in_fparamlist845 =
      new BitSet(new long[] {0xB000800000400802L, 0x0000000004000002L});
  public static final BitSet FOLLOW_fparam_in_fparamlist853 =
      new BitSet(new long[] {0xB000800000400802L, 0x0000000004000002L});
  ...
  public static final BitSet FOLLOW_T_FLOAT_in_term883 =
      new BitSet(new long[] {0x0000000000000004L});
  ...
  public static final BitSet FOLLOW_STRING_in_term896 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_T_UTF8_in_term905 =
      new BitSet(new long[] {0x0000000000000004L});
  ...
  public static final BitSet FOLLOW_dotname_in_term918 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_set_in_expr935 = new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_simpleExpr_in_expr951 =
      new BitSet(new long[] {0xB000800000400800L, 0x0000000004000002L});
  public static final BitSet FOLLOW_simpleExpr_in_expr955 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_71_in_expr964 = new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_simpleExpr_in_expr968 =
      new BitSet(new long[] {0xB000800000400800L, 0x0000000004000002L});
  public static final BitSet FOLLOW_simpleExpr_in_expr972 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_MULTI_ASSIGN_in_expr980 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_varlist_in_expr982 =
      new BitSet(new long[] {0x0000000000200000L});
  public static final BitSet FOLLOW_function_in_expr984 =
      new BitSet(new long[] {0x0000000002000008L, 0x0000000003283000L});
  public static final BitSet FOLLOW_cast_in_expr988 = new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_multExpr_in_simpleExpr1003 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_simpleExpr1012 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_simpleExpr_in_simpleExpr1020 =
      new BitSet(new long[] {0xB000800000400800L, 0x0000000004000002L});
  public static final BitSet FOLLOW_simpleExpr_in_simpleExpr1024 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_exprValue_in_multExpr1039 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_multExpr1048 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_multExpr_in_multExpr1058 =
      new BitSet(new long[] {0x1000800000400800L, 0x0000000004000002L});
  public static final BitSet FOLLOW_multExpr_in_multExpr1062 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_simpleExpr_in_compExpr1079 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_dotname_in_varlist1099 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_dotname_in_varlist1106 =
      new BitSet(new long[] {0x0000000002000002L});
  public static final BitSet FOLLOW_TERM_in_exprValue1123 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_term_in_exprValue1125 =
      new BitSet(new long[] {0x8000000002000008L, 0x0000000003283000L});
  public static final BitSet FOLLOW_63_in_exprValue1130 =
      new BitSet(new long[] {0x0000000002000008L, 0x0000000003283000L});
  public static final BitSet FOLLOW_cast_in_exprValue1136 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_FUNCTION_in_exprValue1145 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_function_in_exprValue1147 =
      new BitSet(new long[] {0x0000000002000008L, 0x0000000003283000L});
  public static final BitSet FOLLOW_cast_in_exprValue1151 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_COMPOUND_EXPR_in_exprValue1160 =
      new BitSet(new long[] {0x0000000000000004L});
  public static final BitSet FOLLOW_compExpr_in_exprValue1162 =
      new BitSet(new long[] {0x0000000002000008L, 0x0000000003283000L});
  public static final BitSet FOLLOW_cast_in_exprValue1166 =
      new BitSet(new long[] {0x0000000000000008L});
  public static final BitSet FOLLOW_type_in_cast1183 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_dotname1197 =
      new BitSet(new long[] {0x0000000000008002L});
  public static final BitSet FOLLOW_DOT_ID_in_dotname1204 =
      new BitSet(new long[] {0x0000000000008002L});
}
