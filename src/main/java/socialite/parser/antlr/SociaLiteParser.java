...
public class SociaLiteParser extends Parser {
  ...
  public String[] getTokenNames() {
    return SociaLiteParser.tokenNames;
  }

  public String getGrammarFileName() {
    return "/Users/jiwon/workspace/socialite/grammar/SociaLite.g";
  }
  ...
  // $ANTLR start "stat"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:81:1: stat : ( table_decl | rule | query |
  // table_stmt );
  public final SociaLiteParser.stat_return stat() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:81:6: ( table_decl | rule | query |
      // table_stmt )
      int alt2 = 4;
      switch (input.LA(1)) {
        case ID:
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:86:1: table_stmt : ( 'clear' ID DOT_END ->
  // ^( CLEAR ID ) | 'drop' ID DOT_END -> ^( DROP ( ID )? ) );
  public final SociaLiteParser.table_stmt_return table_stmt() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:86:12: ( 'clear' ID DOT_END -> ^(
      // CLEAR ID ) | 'drop' ID DOT_END -> ^( DROP ( ID )? ) )
      int alt3 = 2;
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:86:14: 'clear' ID DOT_END
          {
            ...
            // 86:33: -> ^( CLEAR ID )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:86:36: ^( CLEAR ID )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(CLEAR, "CLEAR"), root_1);
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:87:3: 'drop' ID DOT_END
          {
            ...
            // 87:21: -> ^( DROP ( ID )? )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:87:24: ^( DROP ( ID )? )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(DROP, "DROP"), root_1);
  ...
  // $ANTLR start "query"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:90:1: query : '?-' predicate DOT_END -> ^(
  // QUERY predicate ) ;
  public final SociaLiteParser.query_return query() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_predicate =
        new RewriteRuleSubtreeStream(adaptor, "rule predicate");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:90:7: ( '?-' predicate DOT_END -> ^(
      // QUERY predicate ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:90:8: '?-' predicate DOT_END
      {
        ...
        // 90:31: -> ^( QUERY predicate )
        {
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:90:34: ^( QUERY predicate )
          {
            ...
            root_1 =
                (CommonTree)
                    adaptor.becomeRoot((CommonTree) adaptor.create(QUERY, "QUERY"), root_1);
  ...
  // $ANTLR start "rule"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:93:1: rule : head ':-' litlist ( ';' ':-'
  // litlist )* DOT_END -> ( ^( RULE head litlist ) )+ DOT_END ;
  public final SociaLiteParser.rule_return rule() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:93:9: ( head ':-' litlist ( ';' ':-'
      // litlist )* DOT_END -> ( ^( RULE head litlist ) )+ DOT_END )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:93:11: head ':-' litlist ( ';' ':-'
      // litlist )* DOT_END
      {
        ...
        // 94:9: -> ( ^( RULE head litlist ) )+ DOT_END
        {
          ...
          while (stream_litlist.hasNext() || stream_head.hasNext()) {
            // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:94:12: ^( RULE head litlist )
            {
              ...
              root_1 =
                  (CommonTree)
                      adaptor.becomeRoot((CommonTree) adaptor.create(RULE, "RULE"), root_1);
          ...
          adaptor.addChild(root_0, stream_DOT_END.nextNode());
        }
  ...
  // $ANTLR start "literal"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:100:1: literal : ( predicate -> ^(
  // PREDICATE predicate ) | NOT predicate -> ^( PREDICATE NOT predicate ) | expr -> ^( EXPR expr )
  // );
  public final SociaLiteParser.literal_return literal() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:100:9: ( predicate -> ^( PREDICATE
      // predicate ) | NOT predicate -> ^( PREDICATE NOT predicate ) | expr -> ^( EXPR expr ) )
      int alt6 = 3;
      switch (input.LA(1)) {
        case ID:
          {
      ...
      switch (alt6) {
            ...
            // 100:20: -> ^( PREDICATE predicate )
            {
              ...
              // )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(PREDICATE, "PREDICATE"), root_1);
        ...
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:101:4: NOT predicate
          {
            ...
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:101:21: ^( PREDICATE NOT
              // predicate )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 =
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:102:3: expr
          {
            ...
            // 102:8: -> ^( EXPR expr )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:102:11: ^( EXPR expr )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(EXPR, "EXPR"), root_1);
  ...
  // $ANTLR start "expr"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:104:1: expr : ( simpleExpr ( '<' ^| '>' ^|
  // '=' ^| '!=' ^| '==' ^| '>=' ^| '<=' ^) simpleExpr | varlist '=' ( cast )? function -> ^(
  // MULTI_ASSIGN varlist function ( cast )? ) );
  public final SociaLiteParser.expr_return expr() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_function =
        new RewriteRuleSubtreeStream(adaptor, "rule function");
    RewriteRuleSubtreeStream stream_varlist = new RewriteRuleSubtreeStream(adaptor, "rule varlist");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:104:5: ( simpleExpr ( '<' ^| '>' ^|
      // '=' ^| '!=' ^| '==' ^| '>=' ^| '<=' ^) simpleExpr | varlist '=' ( cast )? function -> ^(
      // MULTI_ASSIGN varlist function ( cast )? ) )
      int alt9 = 2;
      ...
      switch (alt9) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:104:7: simpleExpr ( '<' ^| '>' ^|
          // '=' ^| '!=' ^| '==' ^| '>=' ^| '<=' ^) simpleExpr
          {
            root_0 = (CommonTree) adaptor.nil();
          ...
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:105:4: varlist '=' ( cast )?
          // function
          {
            ...
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:105:34: ^( MULTI_ASSIGN
              // varlist function ( cast )? )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(MULTI_ASSIGN, "MULTI_ASSIGN"), root_1);
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:107:1: simpleExpr : multExpr ( ( '+' ^|
  // '-' ^) multExpr )* ;
  public final SociaLiteParser.simpleExpr_return simpleExpr() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:107:11: ( multExpr ( ( '+' ^| '-' ^)
      // multExpr )* )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:107:13: multExpr ( ( '+' ^| '-' ^)
      // multExpr )*
      {
        root_0 = (CommonTree) adaptor.nil();
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:109:1: multExpr : exprValue ( ( '*' ^| '/'
  // ^| 'mod' ^) exprValue )* ;
  public final SociaLiteParser.multExpr_return multExpr() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:109:9: ( exprValue ( ( '*' ^| '/' ^|
      // 'mod' ^) exprValue )* )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:109:11: exprValue ( ( '*' ^| '/' ^|
      // 'mod' ^) exprValue )*
      {
        root_0 = (CommonTree) adaptor.nil();
        ...
        // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:109:21: ( ( '*' ^| '/' ^| 'mod' ^)
        // exprValue )*
        loop13:
        do {
          int alt13 = 2;
          ...
          switch (alt13) {
            case 1:
              ...
              // ^) exprValue
              {
                // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:109:22: ( '*' ^| '/' ^|
                // 'mod' ^)
                int alt12 = 3;
                switch (input.LA(1)) {
                  case 60:
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:110:1: exprValue : ( (neg= '-' )? ( cast
  // )? term -> ^( TERM term ( $neg)? ( cast )? ) | ( cast )? function -> ^( FUNCTION function (
  // cast )? ) | ( cast )? compExpr -> ^( COMPOUND_EXPR compExpr ( cast )? ) );
  public final SociaLiteParser.exprValue_return exprValue() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_function =
        new RewriteRuleSubtreeStream(adaptor, "rule function");
    RewriteRuleSubtreeStream stream_compExpr =
        new RewriteRuleSubtreeStream(adaptor, "rule compExpr");
    RewriteRuleSubtreeStream stream_term = new RewriteRuleSubtreeStream(adaptor, "rule term");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:110:10: ( (neg= '-' )? ( cast )? term
      // -> ^( TERM term ( $neg)? ( cast )? ) | ( cast )? function -> ^( FUNCTION function ( cast )?
                  ...
                  if ((LA18_4 == 78)) {
                    ...
                    if ((LA18_12 == 79)) {
                      ...
                      if ((LA18_21 == 59)) {
                        ...
                        NoViableAltException nvae = new NoViableAltException("", 18, 21, input);
                  ...
                  if ((LA18_5 == 78)) {
                    ...
                    if ((LA18_14 == 79)) {
                      ...
                      if ((LA18_22 == 59)) {
                        ...
                        NoViableAltException nvae = new NoViableAltException("", 18, 22, input);
                  ...
                  if ((LA18_6 == 78)) {
                    ...
                    if ((LA18_15 == 79)) {
                      ...
                      if ((LA18_23 == 59)) {
                        ...
                        NoViableAltException nvae = new NoViableAltException("", 18, 23, input);
                  ...
                  if ((LA18_7 == 78)) {
                    ...
                    if ((LA18_16 == 79)) {
                      ...
                      if ((LA18_24 == 59)) {
                        ...
                        NoViableAltException nvae = new NoViableAltException("", 18, 24, input);
                  ...
                  if ((LA18_8 == 78)) {
                    ...
                    if ((LA18_17 == 79)) {
                      ...
                      if ((LA18_25 == 59)) {
                        ...
                        NoViableAltException nvae = new NoViableAltException("", 18, 25, input);
                  ...
                  if ((LA18_9 == 78)) {
                    ...
                    if ((LA18_18 == 79)) {
                      ...
                      if ((LA18_26 == 59)) {
                        ...
                        NoViableAltException nvae = new NoViableAltException("", 18, 26, input);

                        throw nvae;
                      }
                    } else {
                      NoViableAltException nvae = new NoViableAltException("", 18, 18, input);
                    ...
                    case 78:
                      {
                        ...
                        if ((LA18_19 == 79)) {
                          ...
                          if ((LA18_27 == 59)) {
                            ...
                            NoViableAltException nvae = new NoViableAltException("", 18, 27, input);
                    ...
                    case 59:
                      {
                        switch (input.LA(4)) {
                          ...
                          case 90:
                            ...
                            break;
                          default:
                            NoViableAltException nvae = new NoViableAltException("", 18, 20, input);
      ...
      switch (alt18) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:110:12: (neg= '-' )? ( cast )?
          // term
          {
            ...
            // wildcard labels:
            retval.tree = root_0;
            RewriteRuleTokenStream stream_neg =
                new RewriteRuleTokenStream(adaptor, "token neg", neg);
            RewriteRuleSubtreeStream stream_retval =
                new RewriteRuleSubtreeStream(
                    adaptor, "rule retval", retval != null ? retval.tree : null);
            ...
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:110:37: ^( TERM term ( $neg)?
              // ( cast )? )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(TERM, "TERM"), root_1);
        ...
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:111:4: ( cast )? function
          {
            ...
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:111:22: ^( FUNCTION function (
              // cast )? )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(FUNCTION, "FUNCTION"), root_1);
        ...
        case 3:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:112:4: ( cast )? compExpr
          {
            ...
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:112:22: ^( COMPOUND_EXPR
              // compExpr ( cast )? )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(COMPOUND_EXPR, "COMPOUND_EXPR"), root_1);
  ...
  // $ANTLR start "varlist"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:116:1: varlist : '(' !e1= dotname ( ','
  // !e2= dotname )+ ')' !;
  public final SociaLiteParser.varlist_return varlist() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:116:8: ( '(' !e1= dotname ( ',' !e2=
      // dotname )+ ')' !)
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:116:10: '(' !e1= dotname ( ',' !e2=
      // dotname )+ ')' !
      {
        root_0 = (CommonTree) adaptor.nil();
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:117:1: function : '$' dotname '(' (
  // fparamlist )? ')' -> ^( FUNC dotname ( fparamlist )? ) ;
  public final SociaLiteParser.function_return function() throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_58 = new RewriteRuleTokenStream(adaptor, "token 58");
    RewriteRuleTokenStream stream_59 = new RewriteRuleTokenStream(adaptor, "token 59");
    RewriteRuleSubtreeStream stream_fparamlist =
        new RewriteRuleSubtreeStream(adaptor, "rule fparamlist");
    RewriteRuleSubtreeStream stream_dotname = new RewriteRuleSubtreeStream(adaptor, "rule dotname");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:117:9: ( '$' dotname '(' ( fparamlist
      ...
      // )? ')'
      {
        ...
        {
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:117:46: ^( FUNC dotname (
          // fparamlist )? )
          {
            CommonTree root_1 = (CommonTree) adaptor.nil();
            root_1 =
                (CommonTree) adaptor.becomeRoot((CommonTree) adaptor.create(FUNC, "FUNC"), root_1);
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:120:1: predicate : ID '(' paramlist ')' ->
  // ID paramlist ;
  public final SociaLiteParser.predicate_return predicate() throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_59 = new RewriteRuleTokenStream(adaptor, "token 59");
    RewriteRuleTokenStream stream_ID = new RewriteRuleTokenStream(adaptor, "token ID");
    RewriteRuleSubtreeStream stream_paramlist =
        new RewriteRuleSubtreeStream(adaptor, "rule paramlist");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:120:11: ( ID '(' paramlist ')' -> ID
      // paramlist )
  ...
  // $ANTLR start "term"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:128:1: term : ( INT -> ^( T_INT INT ) |
  // FLOAT -> ^( T_FLOAT FLOAT ) | STRING -> ^( T_STR STRING ) | UTF8 -> ^( T_UTF8 UTF8 ) | dotname
  // -> ^( T_VAR dotname ) );
  public final SociaLiteParser.term_return term() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_dotname = new RewriteRuleSubtreeStream(adaptor, "rule dotname");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:128:5: ( INT -> ^( T_INT INT ) | FLOAT
      // -> ^( T_FLOAT FLOAT ) | STRING -> ^( T_STR STRING ) | UTF8 -> ^( T_UTF8 UTF8 ) | dotname ->
      // ^( T_VAR dotname ) )
      int alt23 = 5;
      switch (input.LA(1)) {
        case INT:
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:128:7: INT
          {
            ...
            // 128:11: -> ^( T_INT INT )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:128:14: ^( T_INT INT )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(T_INT, "T_INT"), root_1);
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:129:3: FLOAT
          {
            ...
            // 129:9: -> ^( T_FLOAT FLOAT )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:129:12: ^( T_FLOAT FLOAT )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(T_FLOAT, "T_FLOAT"), root_1);
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:130:3: STRING
          {
            ...
            // 130:10: -> ^( T_STR STRING )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:130:13: ^( T_STR STRING )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(T_STR, "T_STR"), root_1);
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:131:3: UTF8
          {
            ...
            // 131:8: -> ^( T_UTF8 UTF8 )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:131:11: ^( T_UTF8 UTF8 )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(T_UTF8, "T_UTF8"), root_1);

                adaptor.addChild(root_1, stream_UTF8.nextNode());
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:132:3: dotname
          {
            ...
            // 132:11: -> ^( T_VAR dotname )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:132:14: ^( T_VAR dotname )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(T_VAR, "T_VAR"), root_1);
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:134:1: table_decl : ID '(' decls ')' (
  // table_opts )? DOT_END -> ^( DECL ID decls ^( OPTION ( table_opts )? ) ) ;
  public final SociaLiteParser.table_decl_return table_decl() throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_DOT_END = new RewriteRuleTokenStream(adaptor, "token DOT_END");
    RewriteRuleTokenStream stream_ID = new RewriteRuleTokenStream(adaptor, "token ID");
    RewriteRuleSubtreeStream stream_table_opts =
        new RewriteRuleSubtreeStream(adaptor, "rule table_opts");
    RewriteRuleSubtreeStream stream_decls = new RewriteRuleSubtreeStream(adaptor, "rule decls");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:134:11: ( ID '(' decls ')' (
      // table_opts )? DOT_END -> ^( DECL ID decls ^( OPTION ( table_opts )? ) ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:134:13: ID '(' decls ')' ( table_opts
      // )? DOT_END
      {
        ...
        {
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:134:54: ^( DECL ID decls ^( OPTION
          // ( table_opts )? ) )
          {
            CommonTree root_1 = (CommonTree) adaptor.nil();
            root_1 =
                (CommonTree) adaptor.becomeRoot((CommonTree) adaptor.create(DECL, "DECL"), root_1);
            ...
            // )? )
            {
              ...
              root_2 =
                  (CommonTree)
                      adaptor.becomeRoot((CommonTree) adaptor.create(OPTION, "OPTION"), root_2);
  ...
  // $ANTLR start "t_opt"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:138:1: t_opt : ( 'sortby' col= ID (order=
  // SORT_ORDER )? -> ^( SORT_BY $col ( $order)? ) | 'orderby' ID -> ^( ORDER_BY ID ) | 'indexby' ID
  // -> ^( INDEX_BY ID ) | 'groupby' '(' INT ')' -> ^( GROUP_BY INT ) | 'shardby' ID -> ^( SHARD_BY
  // ID ) | 'predefined' -> PREDEFINED | 'concurrent' -> CONCURRENT | 'multiset' -> MULTISET );
  public final SociaLiteParser.t_opt_return t_opt() throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_59 = new RewriteRuleTokenStream(adaptor, "token 59");
    RewriteRuleTokenStream stream_INT = new RewriteRuleTokenStream(adaptor, "token INT");
    RewriteRuleTokenStream stream_SORT_ORDER =
        new RewriteRuleTokenStream(adaptor, "token SORT_ORDER");
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:138:7: ( 'sortby' col= ID (order=
      // SORT_ORDER )? -> ^( SORT_BY $col ( $order)? ) | 'orderby' ID -> ^( ORDER_BY ID ) |
      // 'indexby' ID -> ^( INDEX_BY ID ) | 'groupby' '(' INT ')' -> ^( GROUP_BY INT ) | 'shardby'
      // ID -> ^( SHARD_BY ID ) | 'predefined' -> PREDEFINED | 'concurrent' -> CONCURRENT |
      // 'multiset' -> MULTISET )
      int alt27 = 8;
      switch (input.LA(1)) {
        case 95:
      ...
      switch (alt27) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:138:8: 'sortby' col= ID (order=
          // SORT_ORDER )?
          {
            ...
            // wildcard labels:
            retval.tree = root_0;
            RewriteRuleTokenStream stream_col =
                new RewriteRuleTokenStream(adaptor, "token col", col);
            RewriteRuleTokenStream stream_order =
                new RewriteRuleTokenStream(adaptor, "token order", order);
            RewriteRuleSubtreeStream stream_retval =
                new RewriteRuleSubtreeStream(
                    adaptor, "rule retval", retval != null ? retval.tree : null);
            ...
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:138:47: ^( SORT_BY $col (
              // $order)? )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(SORT_BY, "SORT_BY"), root_1);
            ...
            // 139:16: -> ^( ORDER_BY ID )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:139:19: ^( ORDER_BY ID )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(ORDER_BY, "ORDER_BY"), root_1);
            ...
            // 140:16: -> ^( INDEX_BY ID )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:140:19: ^( INDEX_BY ID )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(INDEX_BY, "INDEX_BY"), root_1);
            ...
            // 141:25: -> ^( GROUP_BY INT )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:141:28: ^( GROUP_BY INT )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(GROUP_BY, "GROUP_BY"), root_1);
            ...
            // 142:16: -> ^( SHARD_BY ID )
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:142:19: ^( SHARD_BY ID )
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot(
                            (CommonTree) adaptor.create(SHARD_BY, "SHARD_BY"), root_1);
        ...
        case 6:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:143:3: 'predefined'
          {
            ...
            // 143:16: -> PREDEFINED
            {
              adaptor.addChild(root_0, (CommonTree) adaptor.create(PREDEFINED, "PREDEFINED"));
            }
        ...
        case 7:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:144:3: 'concurrent'
          {
            ...
            // 144:16: -> CONCURRENT
            {
              adaptor.addChild(root_0, (CommonTree) adaptor.create(CONCURRENT, "CONCURRENT"));
            }
        ...
        case 8:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:145:3: 'multiset'
          {
            ...
            // 145:14: -> MULTISET
            {
              adaptor.addChild(root_0, (CommonTree) adaptor.create(MULTISET, "MULTISET"));
            }
  ...
  // $ANTLR start "decls"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:149:1: decls : col_decls ( ',' '(' decls
  // ')' )? -> ^( COL_DECLS col_decls ^( DECL ( decls )? ) ) ;
  public final SociaLiteParser.decls_return decls() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_decls = new RewriteRuleSubtreeStream(adaptor, "rule decls");
    RewriteRuleSubtreeStream stream_col_decls =
        new RewriteRuleSubtreeStream(adaptor, "rule col_decls");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:149:7: ( col_decls ( ',' '(' decls ')'
      // )? -> ^( COL_DECLS col_decls ^( DECL ( decls )? ) ) )
      ...
      // )?
      {
        ...
        {
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:149:43: ^( COL_DECLS col_decls ^(
          // DECL ( decls )? ) )
          {
            CommonTree root_1 = (CommonTree) adaptor.nil();
            root_1 =
                (CommonTree)
                    adaptor.becomeRoot((CommonTree) adaptor.create(COL_DECLS, "COL_DECLS"), root_1);
            ...
            // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:149:65: ^( DECL ( decls )? )
            {
              ...
              root_2 =
                  (CommonTree)
                      adaptor.becomeRoot((CommonTree) adaptor.create(DECL, "DECL"), root_2);
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:151:1: col_decls : col_decl ( ',' !
  // col_decl )* ;
  ...
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:153:1: col_decl : type ID ( ':' col_opt )?
  ...
  public final SociaLiteParser.col_decl_return col_decl() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_type = new RewriteRuleSubtreeStream(adaptor, "rule type");
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:153:9: ( type ID ( ':' col_opt )? ->
      // ^( COL_DECL type ID ( col_opt )? ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:153:11: type ID ( ':' col_opt )?
      {
        ...
        {
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:153:36: ^( COL_DECL type ID (
          // col_opt )? )
          {
            CommonTree root_1 = (CommonTree) adaptor.nil();
            root_1 =
                (CommonTree)
                    adaptor.becomeRoot((CommonTree) adaptor.create(COL_DECL, "COL_DECL"), root_1);
  ...
  // $ANTLR start "col_opt"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:155:1: col_opt : (i1= INT '..' i2= INT ->
  // ^( RANGE $i1 $i2) | ITER_DECL -> ITER |i1= INT 'bit' -> ^( BIT $i1) );
  public final SociaLiteParser.col_opt_return col_opt() throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_ITER_DECL =
        new RewriteRuleTokenStream(adaptor, "token ITER_DECL");
    RewriteRuleTokenStream stream_64 = new RewriteRuleTokenStream(adaptor, "token 64");
    RewriteRuleTokenStream stream_INT = new RewriteRuleTokenStream(adaptor, "token INT");

    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:155:9: (i1= INT '..' i2= INT -> ^(
      // RANGE $i1 $i2) | ITER_DECL -> ITER |i1= INT 'bit' -> ^( BIT $i1) )
      int alt31 = 3;
      ...
      switch (alt31) {
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:155:11: i1= INT '..' i2= INT
          {
            ...
            // 155:30: -> ^( RANGE $i1 $i2)
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:155:33: ^( RANGE $i1 $i2)
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(RANGE, "RANGE"), root_1);
        ...
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:156:4: ITER_DECL
          {
            ...
            // 156:14: -> ITER
            {
              adaptor.addChild(root_0, (CommonTree) adaptor.create(ITER, "ITER"));
            }
          ...
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:157:4: i1= INT 'bit'
          {
            ...
            // 157:17: -> ^( BIT $i1)
            {
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:157:20: ^( BIT $i1)
              {
                ...
                root_1 =
                    (CommonTree)
                        adaptor.becomeRoot((CommonTree) adaptor.create(BIT, "BIT"), root_1);
  ...
  // $ANTLR start "type"
  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:160:1: type : ( 'int' ( '[' ']' )? |
  ...
  public final SociaLiteParser.type_return type() throws RecognitionException {
    ...
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:160:5: ( 'int' ( '[' ']' )? | 'long' (
      // '[' ']' )? | 'float' ( '[' ']' )? | 'double' ( '[' ']' )? | 'String' ( '[' ']' )? |
      // 'Object' ( '[' ']' )? | ID ( '[' ']' )? )
      int alt39 = 7;
      switch (input.LA(1)) {
      ...
      switch (alt39) {
        ...
        case 7:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:166:4: ID ( '[' ']' )?
          {
            ...
            ID146_tree = (CommonTree) adaptor.create(ID146);
          ...
          switch (alt40) {
            case 1:
              // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:168:14: DOT_ID
              {
                ...
                DOT_ID150_tree = (CommonTree) adaptor.create(DOT_ID150);
  ...
  static final String DFA9_minS = "\1\24\1\uffff\1\24\2\17\1\uffff";
  static final String DFA9_maxS = "\1\77\1\uffff\1\131\2\132\1\uffff";
  static final String DFA9_acceptS = "\1\uffff\1\1\3\uffff\1\2";
  static final String DFA9_specialS = "\6\uffff}>";
  static final String[] DFA9_transitionS = {
    "\1\1\4\uffff\1\1\2\uffff\1\1\21\uffff\1\1\7\uffff\1\1\2\uffff" + "\1\1\1\2\4\uffff\1\1",
    "",
    "\1\1\4\uffff\1\3\2\uffff\1\1\21\uffff\1\1\7\uffff\1\1\2\uffff"
        + "\2\1\4\uffff\1\1\14\uffff\2\1\5\uffff\1\1\1\uffff\1\1\2\uffff"
        + "\2\1",
    "\1\4\53\uffff\3\1\1\5\1\1\1\uffff\1\1\14\uffff\1\1\13\uffff" + "\1\1",
  ...
  public static final BitSet FOLLOW_stat_in_prog304 =
      new BitSet(new long[] {0x0000000002000000L, 0x0000000000120800L});
  public static final BitSet FOLLOW_EOF_in_prog307 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_table_decl_in_stat313 =
  ...
  public static final BitSet FOLLOW_table_stmt_in_stat325 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_81_in_table_stmt334 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_ID_in_table_stmt336 =
      new BitSet(new long[] {0x0000000000004000L});
  public static final BitSet FOLLOW_DOT_END_in_table_stmt338 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_84_in_table_stmt351 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_ID_in_table_stmt353 =
      new BitSet(new long[] {0x0000000000004000L});
  public static final BitSet FOLLOW_DOT_END_in_table_stmt355 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_75_in_query373 = new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_predicate_in_query375 =
      new BitSet(new long[] {0x0000000000004000L});
  public static final BitSet FOLLOW_DOT_END_in_query377 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_head_in_rule398 =
  ...
  public static final BitSet FOLLOW_litlist_in_rule402 =
      new BitSet(new long[] {0x0000000000004000L, 0x0000000000000010L});
  public static final BitSet FOLLOW_68_in_rule405 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000000008L});
  public static final BitSet FOLLOW_67_in_rule407 = new BitSet(new long[] {0x8640400212100000L});
  public static final BitSet FOLLOW_litlist_in_rule409 =
      new BitSet(new long[] {0x0000000000004000L, 0x0000000000000010L});
  public static final BitSet FOLLOW_DOT_END_in_rule413 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_predicate_in_head450 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_literal_in_litlist457 =
  ...
  public static final BitSet FOLLOW_literal_in_litlist463 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_predicate_in_literal472 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_NOT_in_literal486 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_predicate_in_literal488 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_expr_in_literal502 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_simpleExpr_in_expr519 =
      new BitSet(new long[] {0x0100000000000000L, 0x00000000000007E0L});
  ...
  public static final BitSet FOLLOW_simpleExpr_in_expr557 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_varlist_in_expr562 =
  ...
  public static final BitSet FOLLOW_function_in_expr569 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_multExpr_in_simpleExpr591 =
      new BitSet(new long[] {0xA000000000000002L});
  public static final BitSet FOLLOW_61_in_simpleExpr596 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_63_in_simpleExpr599 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_multExpr_in_simpleExpr603 =
      new BitSet(new long[] {0xA000000000000002L});
  public static final BitSet FOLLOW_exprValue_in_multExpr614 =
      new BitSet(new long[] {0x1000000000000002L, 0x0000000004000002L});
  public static final BitSet FOLLOW_60_in_multExpr618 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_65_in_multExpr621 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_90_in_multExpr624 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_exprValue_in_multExpr628 =
      new BitSet(new long[] {0x1000000000000002L, 0x0000000004000002L});
  public static final BitSet FOLLOW_63_in_exprValue639 =
      new BitSet(new long[] {0x0440400012100000L});
  public static final BitSet FOLLOW_cast_in_exprValue643 =
      new BitSet(new long[] {0x0040400012100000L});
  public static final BitSet FOLLOW_term_in_exprValue646 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_cast_in_exprValue666 =
      new BitSet(new long[] {0x0200000000000000L});
  public static final BitSet FOLLOW_function_in_exprValue669 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_cast_in_exprValue685 =
      new BitSet(new long[] {0x0400000000000000L});
  public static final BitSet FOLLOW_compExpr_in_exprValue688 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_58_in_compExpr707 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_simpleExpr_in_compExpr710 =
      new BitSet(new long[] {0x0800000000000000L});
  public static final BitSet FOLLOW_59_in_compExpr712 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_58_in_cast721 =
      new BitSet(new long[] {0x0000000002000000L, 0x0000000003283000L});
  ...
  public static final BitSet FOLLOW_dotname_in_varlist742 =
  ...
  public static final BitSet FOLLOW_dotname_in_varlist751 =
  ...
  public static final BitSet FOLLOW_57_in_function763 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_dotname_in_function765 =
      new BitSet(new long[] {0x0400000000000000L});
  public static final BitSet FOLLOW_58_in_function767 =
      new BitSet(new long[] {0x8E40400012100000L});
  public static final BitSet FOLLOW_fparamlist_in_function769 =
      new BitSet(new long[] {0x0800000000000000L});
  public static final BitSet FOLLOW_59_in_function772 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_predicate792 =
      new BitSet(new long[] {0x0400000000000000L});
  public static final BitSet FOLLOW_58_in_predicate794 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_paramlist_in_predicate796 =
      new BitSet(new long[] {0x0800000000000000L});
  public static final BitSet FOLLOW_59_in_predicate798 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_param_in_paramlist811 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_62_in_paramlist814 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_param_in_paramlist817 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_fparam_in_fparamlist825 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_62_in_fparamlist828 =
      new BitSet(new long[] {0x8640400012100000L});
  public static final BitSet FOLLOW_fparam_in_fparamlist831 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_simpleExpr_in_param840 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_simpleExpr_in_fparam846 =
      new BitSet(new long[] {0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_STRING_in_term878 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_UTF8_in_term890 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_dotname_in_term903 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_table_decl919 =
      new BitSet(new long[] {0x0400000000000000L});
  public static final BitSet FOLLOW_58_in_table_decl921 =
      new BitSet(new long[] {0x0000000002000000L, 0x0000000003283000L});
  public static final BitSet FOLLOW_decls_in_table_decl923 =
      new BitSet(new long[] {0x0800000000000000L});
  public static final BitSet FOLLOW_59_in_table_decl925 =
      new BitSet(new long[] {0x0000000000004000L, 0x00000000F8C40000L});
  public static final BitSet FOLLOW_table_opts_in_table_decl927 =
      new BitSet(new long[] {0x0000000000004000L});
  public static final BitSet FOLLOW_DOT_END_in_table_decl930 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_t_opt_in_table_opts963 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_62_in_table_opts966 =
      new BitSet(new long[] {0x0000000000000000L, 0x00000000F8C40000L});
  public static final BitSet FOLLOW_t_opt_in_table_opts969 =
      new BitSet(new long[] {0x4000000000000002L});
  ...
  public static final BitSet FOLLOW_SORT_ORDER_in_t_opt988 =
      new BitSet(new long[] {0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_col_decls_in_decls1107 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_62_in_decls1110 = new BitSet(new long[] {0x0400000000000000L});
  public static final BitSet FOLLOW_58_in_decls1112 =
      new BitSet(new long[] {0x0000000002000000L, 0x0000000003283000L});
  public static final BitSet FOLLOW_decls_in_decls1114 =
      new BitSet(new long[] {0x0800000000000000L});
  public static final BitSet FOLLOW_59_in_decls1116 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_col_decl_in_col_decls1142 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_62_in_col_decls1145 =
      new BitSet(new long[] {0x0000000002000000L, 0x0000000003283000L});
  public static final BitSet FOLLOW_col_decl_in_col_decls1148 =
      new BitSet(new long[] {0x4000000000000002L});
  public static final BitSet FOLLOW_type_in_col_decl1158 =
      new BitSet(new long[] {0x0000000002000000L});
  public static final BitSet FOLLOW_ID_in_col_decl1160 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000000004L});
  public static final BitSet FOLLOW_66_in_col_decl1163 =
      new BitSet(new long[] {0x0000000050000000L});
  public static final BitSet FOLLOW_col_opt_in_col_decl1165 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_INT_in_col_opt1190 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000000001L});
  public static final BitSet FOLLOW_64_in_col_opt1192 =
      new BitSet(new long[] {0x0000000010000000L});
  public static final BitSet FOLLOW_INT_in_col_opt1196 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ITER_DECL_in_col_opt1213 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_INT_in_col_opt1224 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000010000L});
  public static final BitSet FOLLOW_80_in_col_opt1226 =
      new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_88_in_type1244 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1247 =
  ...
  public static final BitSet FOLLOW_89_in_type1255 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1258 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type1260 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_85_in_type1268 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1271 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type1273 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_83_in_type1281 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1284 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type1286 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_77_in_type1294 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1297 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type1299 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_76_in_type1307 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1310 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type1312 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_type1319 =
      new BitSet(new long[] {0x0000000000000002L, 0x0000000000004000L});
  public static final BitSet FOLLOW_78_in_type1322 =
      new BitSet(new long[] {0x0000000000000000L, 0x0000000000008000L});
  public static final BitSet FOLLOW_79_in_type1324 = new BitSet(new long[] {0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_dotname1336 =
      new BitSet(new long[] {0x0000000000008002L});
  public static final BitSet FOLLOW_DOT_ID_in_dotname1339 =
      new BitSet(new long[] {0x0000000000008002L});
}
