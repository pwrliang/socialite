...
public class SociaLiteLexer extends Lexer {
  ...
  public final void mID() throws RecognitionException {
    try {
      int _type = ID;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:173:5: ( ( 'a' .. 'z' | 'A' .. 'Z' |
      // '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:173:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_'
      // ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
      {
        ...
        // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:173:31: ( 'a' .. 'z' | 'A' .. 'Z' |
        // '0' .. '9' | '_' )*
        loop4:
        do {
          int alt4 = 2;
  ...
  public final void mDOT_ID() throws RecognitionException {
    try {
      int _type = DOT_ID;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:174:7: ( '.' ( 'a' .. 'z' | 'A' .. 'Z'
      // | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:174:9: '.' ( 'a' .. 'z' | 'A' .. 'Z' |
      // '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
      {
        match('.');
        ...
        // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:174:36: ( 'a' .. 'z' | 'A' .. 'Z' |
        // '0' .. '9' | '_' )*
        loop5:
        do {
          int alt5 = 2;
  ...
  public final void mFLOAT() throws RecognitionException {
    try {
      int _type = FLOAT;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:190:5: ( ( '0' .. '9' )+ ({...}? =>
      ...
      switch (alt14) {
        case 1:
          ...
          // '.' ( '0' .. '9' )+ ( EXPONENT )? ( 'f' | 'F' | 'd' | 'D' )? |)
          {
            ...
            // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:191:5: ({...}? => '.' ( '0' ..
            // '9' )+ ( EXPONENT )? ( 'f' | 'F' | 'd' | 'D' )? |)
            int alt12 = 2;
            ...
            switch (alt12) {
              case 1:
                // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:191:7: {...}? => '.' ( '0'
                // .. '9' )+ ( EXPONENT )? ( 'f' | 'F' | 'd' | 'D' )?
                {
                  if (!((input.LA(2) != '.'
                      && input.LA(2) != ' '
                  ...
                  // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:193:60: ( 'f' | 'F' | 'd'
                  // | 'D' )?
                  int alt11 = 2;
    ...
    try {
      ...
      switch (alt20) {
        case 1:
          ...
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:205:9: '/*' ( options
          // {greedy=false; } : . )* '*/'
          {
            match("/*");
  ...
  public final void mEXPONENT() throws RecognitionException {
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:229:10: ( ( 'e' | 'E' ) ( '+' | '-' )?
      // ( '0' .. '9' )+ )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:229:12: ( 'e' | 'E' ) ( '+' | '-' )? (
      // '0' .. '9' )+
      {
  ...
  public final void mHEX_DIGIT() throws RecognitionException {
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:232:11: ( ( '0' .. '9' | 'a' .. 'f' |
      // 'A' .. 'F' ) )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:
      {
        if ((input.LA(1) >= '0' && input.LA(1) <= '9')
  ...
  public final void mESC_SEQ() throws RecognitionException {
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:236:5: ( '\\\\' ( 'b' | 't' | 'n' |
      // 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
      int alt26 = 3;
      ...
      switch (alt26) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:236:9: '\\\\' ( 'b' | 't' | 'n' |
          // 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
          {
            match('\\');
  ...
  public final void mOCTAL_ESC() throws RecognitionException {
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:243:5: ( '\\\\' ( '0' .. '3' ) ( '0'
      // .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
      int alt27 = 3;
      ...
      switch (alt27) {
        case 1:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:243:9: '\\\\' ( '0' .. '3' ) ( '0'
          // .. '7' ) ( '0' .. '7' )
          {
            match('\\');
          ...
          break;
        case 2:
          // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:244:9: '\\\\' ( '0' .. '7' ) ( '0'
          // .. '7' )
          {
            match('\\');
  ...
  public final void mUNICODE_ESC() throws RecognitionException {
    try {
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:250:5: ( '\\\\' 'u' HEX_DIGIT
      // HEX_DIGIT HEX_DIGIT HEX_DIGIT )
      // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:250:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT
      // HEX_DIGIT HEX_DIGIT
      {
        match('\\');
  ...
  public void mTokens() throws RecognitionException {
    // /Users/jiwon/workspace/socialite/grammar/SociaLite.g:1:8: ( T__56 | T__57 | T__58 | T__59 |
    // T__60 | T__61 | T__62 | T__63 | T__64 | T__65 | T__66 | T__67 | T__68 | T__69 | T__70 | T__71
    // | T__72 | T__73 | T__74 | T__75 | T__76 | T__77 | T__78 | T__79 | T__80 | T__81 | T__82 |
    // T__83 | T__84 | T__85 | T__86 | T__87 | T__88 | T__89 | T__90 | T__91 | T__92 | T__93 | T__94
    // | T__95 | SORT_ORDER | ITER_DECL | NOT | ID | DOT_ID | DOT_END | INT | FLOAT | COMMENT | WS |
    // UTF8 | STRING | CHAR )
    int alt28 = 53;
  ...
  static final String DFA14_eotS = "\1\uffff\1\2\2\uffff";
  static final String DFA14_eofS = "\4\uffff";
  static final String DFA14_minS = "\2\60\2\uffff";
  static final String DFA14_maxS = "\1\71\1\145\2\uffff";
  static final String DFA14_acceptS = "\2\uffff\1\1\1\2";
  static final String DFA14_specialS = "\4\uffff}>";
  static final String[] DFA14_transitionS = {"\12\1", "\12\1\13\uffff\1\3\37\uffff\1\3", "", ""};
