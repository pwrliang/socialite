...
/** Table Partition Map. This maps a value (of the 1st column) to its corresponding partition. */
public class TablePartitionMap {
  ...
  public int getIndex(int tableId, long rangeOrHash) {
    return partitionInfo.get(tableId).getIndex(rangeOrHash);
  }

  public int getIndex(int tableId, float rangeOrHash) {
    return getHashIndex(tableId, rangeOrHash);
  }

  public int getIndex(int tableId, double rangeOrHash) {
    return getHashIndex(tableId, rangeOrHash);
  }
