...
public class CodeGenMain {
  ...
  public LinkedHashMap<String, byte[]> getGeneratedClasses() {
  ...
  void generateAndSetEval(Epoch e) {
    ...
    for (Table t : e.getNewTables()) {
      if (!(t instanceof GeneratedT)) newTablesToAlloc.add(t);
    }
  ...
  public Runnable getQueryInst() {
    if (queryClass == null || query == null || queryVisitor == null) return null;
...
class QuerySignature {
  ...
  public int hashCode() {
    return name.hashCode() ^ constIdx.hashCode();
  }
  ...
  public boolean equals(Object o) {
    ...
    return name.equals(sig.name)
        && constIdx.equals(sig.constIdx)
        && dontcareIdx.equals(sig.dontcareIdx);
  }
