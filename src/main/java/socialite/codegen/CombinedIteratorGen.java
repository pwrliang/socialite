...
/** Helper of JoinerCodeGen. Generates combined-iterators for lock-step iterations. */
public class CombinedIteratorGen {
  ...
  public static boolean canCombineIterate(Table t1, Table t2, Predicate p, Predicate nextP) {
    ...
    if (t2 instanceof ArrayTable && !(t1 instanceof ArrayTable)) {
      return false;
    }
    ...
    if (param1 instanceof Variable && param2 instanceof Variable) {
      ...
      if (t1.nestingDepth() != t2.nestingDepth()) {
        return false;
      }
  ...
  static boolean canCombineIterate(
      Table t1, Table t2, ColumnGroup cols1, ColumnGroup cols2, Predicate p, Predicate nextP) {
  ...
  static String generate_arr_and_arr(
      int nestLevel, Table t1, Table t2, String visitorVar1, String visitorVar2) {
  ...
  static String generate_dyn_and_dyn(
      int nestLevel, Table t1, Table t2, String visitorVar1, String visitorVar2) {
  ...
  static String generate_arr_and_dyn(
      int nestLevel, Table t1, Table t2, String visitorVar1, String visitorVar2) {
  ...
  static String generate_dyn_and_arr(
      int nestLevel, Table t1, Table t2, String visitorVar1, String visitorVar2) {
  ...
  static void _generate(
      int nestLevel, ST st, Table t1, Table t2, String visitorVar1, String visitorVar2) {
