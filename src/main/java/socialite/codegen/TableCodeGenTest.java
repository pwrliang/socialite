...
public class TableCodeGenTest {
  ...
  static void testNestedTable() {
    String query =
        "Attr1b(int s:0..10, (int t:0..10, String str)).\n"
    ...
    Map<String, Table> map = an.getTableMap();
    Table t1 = map.get("Attr1b");
    Assert.true_(t1.getColumnGroups().size() == 2);
    ...
    Assert.true_(t1.getColumnGroups().size() == 2);
    t1 = map.get("Attr3b");
    Assert.true_(t1.getColumnGroups().size() == 3);
    t1 = map.get("Attr4b");
    Assert.true_(t1.getColumnGroups().size() == 2);
    t1 = map.get("Edge");
    Assert.true_(t1.getColumnGroups().size() == 2);
  ...
  static void testInstantiateTable() {
    String query =
        "Attr3c(String s, (double d, String s2, (int n))) sortby d, indexby n.\n"
  ...
  static void testFlatTableWithIndex() {
    String query =
        "Attr1d(int n:0..10, int t, String s).\n"
  ...
  static void testNestedTableWithIndex() {
    String query =
        "Nested1e(int n:0..10, (int t, String s)).\n"
  ...
  static void testIterateBy() {
    String query =
        "UnNested1f(int n:0..10, int t, String s).\n"
  ...
  static void ensureExistTable(List<Table> tables) {
    try {
      TableCodeGen.ensureExist(tables);
  ...
  static void testObjectColumnGen() {
    String query =
        "ObjTable(int s:1..128, (String obj)) sortby obj desc .\n"
  ...
  static void testSortbyInPlace() {
    String query =
        "TestSb(int s, (int a)) sortby a asc .\n"
            + "TestSb(i, o) :- i=1, o=2. "
            + "TestSb(i, o) :- i=1, o=8. "
            + "TestSb(i, o) :- i=1, o=1. "
            + "TestSb(i, o) :- i=1, o=9. "
  ...
  static void testSortby() {
    String query =
        "TestSb(int s, String obj) indexby s, sortby obj asc. \n"
  ...
  static void testNestedSortby() {
    String query =
        "TestSb(int s, (String obj, int a)) indexby s, sortby a asc.\n"
  ...
  static void testTableSize() {
    String query =
        "TestSize(int s:1000, String obj).\n"
  ...
  static void testAggrColumn1() {
    ...
    s[0] = "";
    query =
        "Bar2(int a, int b, double d).\n"
            + "Bar2(1,$min(b), d) :- b=10, d=1.0 . "
            + "Bar2(1,$min(b), d) :- b=0, d=2.0 . "
            + "?-Bar2(1, b, c).";
    en.run(
        query,
        new QueryVisitor() {
  ...
  static void testAggrColumn2() {
    String query =
        "Foo1(int a:0..1, int b, (double c)) sortby c asc.\n"
    ...
    query =
        "Bar1(int a:0..1, int b, String s, (double c)) sortby c asc.\n"
    ...
    query =
        "Foo2(int a, int b, (double c)) sortby c asc.\n"
    ...
    query =
        "Bar2(int a, int b, String s, (double c)) sortby c.\n"
    ...
    query =
        "Bar3(int a:0..10, (String s, int b, (double c))) sortby c.\n"
    ...
    query =
        "Foo3(int a, (String s, int b, (double c))) sortby c.\n"
  ...
  public static void main(String[] args) {
    ...
    testNestedTable();
    dot();
    testInstantiateTable();
    dot();
    testFlatTableWithIndex();
    dot();
    testNestedTableWithIndex();
    dot();
    testIterateBy();
    dot();
    testDeltaTable();
