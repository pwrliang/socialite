...
public class Compiler {
  ...
  public boolean compile(String name, String sourceCode) {
    ...
    JavaMemFileManager fileManager =
        new JavaMemFileManager(compiler.getStandardFileManager(dc, null, null));
    try {
    ...
    JavaCompiler.CompilationTask task =
        compiler.getTask(null, fileManager, dc, options, null, compUnit);
...
class JavaSourceFromString extends SimpleJavaFileObject {
  ...
  JavaSourceFromString(String name, String code) {
    ...
    try {
      ...
      BufferedWriter bw = new BufferedWriter(new FileWriter(super.toUri().getPath()));
      bw.write(code);
      bw.close();
    } catch (IOException e) {
