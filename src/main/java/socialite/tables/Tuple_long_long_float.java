...
public class Tuple_long_long_float extends Tuple implements Externalizable {
  ...
  public Tuple_long_long_float() {}

  public Tuple_long_long_float(long __0, long __1, float __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_long_long_float clone() {
    return new Tuple_long_long_float(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_long_long_float))
      throw new SociaLiteException("Not supported operation");

    Tuple_long_long_float t = (Tuple_long_long_float) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_long_long_float.class)) {
      Tuple_long_long_float t = (Tuple_long_long_float) _t;
