...
public class Tuple_double_double extends Tuple implements Externalizable {
  private static final long serialVersionUID = 1;

  public double _0;
  public double _1;

  public Tuple_double_double() {}

  public Tuple_double_double(double __0, double __1) {
    _0 = __0;
    _1 = __1;
  }

  public Tuple_double_double clone() {
    return new Tuple_double_double(_0, _1);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_double_double))
      throw new SociaLiteException("Not supported operation");

    Tuple_double_double t = (Tuple_double_double) _t;
    _0 = t._0;
    _1 = t._1;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_double_double.class)) {
      Tuple_double_double t = (Tuple_double_double) _t;
