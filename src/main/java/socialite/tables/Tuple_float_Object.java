...
public class Tuple_float_Object extends Tuple implements Externalizable {
  private static final long serialVersionUID = 1;

  public float _0;
  public Object _1;

  public Tuple_float_Object() {}

  public Tuple_float_Object(float __0, Object __1) {
    _0 = __0;
    _1 = __1;
  }

  public Tuple_float_Object clone() {
    return new Tuple_float_Object(_0, _1);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_float_Object))
      throw new SociaLiteException("Not supported operation");

    Tuple_float_Object t = (Tuple_float_Object) _t;
    _0 = t._0;
    _1 = t._1;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_float_Object.class)) {
      Tuple_float_Object t = (Tuple_float_Object) _t;
