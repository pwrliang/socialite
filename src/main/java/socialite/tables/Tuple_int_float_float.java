...
public class Tuple_int_float_float extends Tuple implements Externalizable {
  ...
  public Tuple_int_float_float() {}

  public Tuple_int_float_float(int __0, float __1, float __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_int_float_float clone() {
    return new Tuple_int_float_float(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_int_float_float))
      throw new SociaLiteException("Not supported operation");

    Tuple_int_float_float t = (Tuple_int_float_float) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_int_float_float.class)) {
      Tuple_int_float_float t = (Tuple_int_float_float) _t;
