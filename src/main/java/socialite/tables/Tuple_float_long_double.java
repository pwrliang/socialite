...
public class Tuple_float_long_double extends Tuple implements Externalizable {
  ...
  public Tuple_float_long_double() {}

  public Tuple_float_long_double(float __0, long __1, double __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_float_long_double clone() {
    return new Tuple_float_long_double(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_float_long_double))
      throw new SociaLiteException("Not supported operation");

    Tuple_float_long_double t = (Tuple_float_long_double) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_float_long_double.class)) {
      Tuple_float_long_double t = (Tuple_float_long_double) _t;
