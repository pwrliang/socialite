...
public class ColumnRange implements Constraint {
  ...
  public int getFrom(int unused) {
    return (int) lfrom;
  }

  public int getTo(int unused) {
    return (int) lto;
  }

  public long getFrom(long unused) {
    return lfrom;
  }

  public long getTo(long unused) {
    return lto;
  }

  public float getFrom(float unused) {
    return (float) dfrom;
  }

  public float getTo(float unused) {
    return (float) dto;
  }

  public double getFrom(double unused) {
    return dfrom;
  }

  public double getTo(double unused) {
    return dto;
  }
