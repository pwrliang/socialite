...
public class Tuple_long_double_int extends Tuple implements Externalizable {
  ...
  public Tuple_long_double_int() {}

  public Tuple_long_double_int(long __0, double __1, int __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_long_double_int clone() {
    return new Tuple_long_double_int(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_long_double_int))
      throw new SociaLiteException("Not supported operation");

    Tuple_long_double_int t = (Tuple_long_double_int) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_long_double_int.class)) {
      Tuple_long_double_int t = (Tuple_long_double_int) _t;
