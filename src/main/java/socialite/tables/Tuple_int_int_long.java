...
public class Tuple_int_int_long extends Tuple implements Externalizable {
  ...
  public Tuple_int_int_long() {}

  public Tuple_int_int_long(int __0, int __1, long __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_int_int_long clone() {
    return new Tuple_int_int_long(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_int_int_long))
      throw new SociaLiteException("Not supported operation");

    Tuple_int_int_long t = (Tuple_int_int_long) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_int_int_long.class)) {
      Tuple_int_int_long t = (Tuple_int_int_long) _t;
