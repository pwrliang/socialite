...
public class Tuple_long_int_double extends Tuple implements Externalizable {
  ...
  public Tuple_long_int_double() {}

  public Tuple_long_int_double(long __0, int __1, double __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_long_int_double clone() {
    return new Tuple_long_int_double(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_long_int_double))
      throw new SociaLiteException("Not supported operation");

    Tuple_long_int_double t = (Tuple_long_int_double) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_long_int_double.class)) {
      Tuple_long_int_double t = (Tuple_long_int_double) _t;
