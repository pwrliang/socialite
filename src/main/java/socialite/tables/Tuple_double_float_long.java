...
public class Tuple_double_float_long extends Tuple implements Externalizable {
  ...
  public Tuple_double_float_long() {}

  public Tuple_double_float_long(double __0, float __1, long __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_double_float_long clone() {
    return new Tuple_double_float_long(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_double_float_long))
      throw new SociaLiteException("Not supported operation");

    Tuple_double_float_long t = (Tuple_double_float_long) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_double_float_long.class)) {
      Tuple_double_float_long t = (Tuple_double_float_long) _t;
