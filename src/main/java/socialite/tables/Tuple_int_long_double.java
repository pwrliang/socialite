...
public class Tuple_int_long_double extends Tuple implements Externalizable {
  ...
  public Tuple_int_long_double() {}

  public Tuple_int_long_double(int __0, long __1, double __2) {
    _0 = __0;
    _1 = __1;
    _2 = __2;
  }

  public Tuple_int_long_double clone() {
    return new Tuple_int_long_double(_0, _1, _2);
  }
  ...
  public void update(Tuple _t) {
    if (!(_t instanceof Tuple_int_long_double))
      throw new SociaLiteException("Not supported operation");

    Tuple_int_long_double t = (Tuple_int_long_double) _t;
    _0 = t._0;
    _1 = t._1;
    _2 = t._2;
  }
  ...
  public boolean equals(Object o) {
    ...
    Tuple _t = (Tuple) o;
    if (_t.getClass().equals(Tuple_int_long_double.class)) {
      Tuple_int_long_double t = (Tuple_int_long_double) _t;
