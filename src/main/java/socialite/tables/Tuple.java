...
public abstract class Tuple {
  ...
  public void setInt(int column, int val) {
    throw new UnsupportedOperationException();
  }

  public void setLong(int column, Long val) {
    throw new UnsupportedOperationException();
  }

  public void setFloat(int column, float val) {
    throw new UnsupportedOperationException();
  }

  public void setDouble(int column, double val) {
    throw new UnsupportedOperationException();
  }

  public void setObject(int column, Object val) {
    throw new UnsupportedOperationException();
  }
