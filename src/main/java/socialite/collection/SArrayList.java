...
public class SArrayList<E> extends ArrayList<E> implements Externalizable {
  ...
  public SArrayList(Collection<? extends E> c) {
    super(c);
  }
  ...
  int binarySearch(E value, int fromIndex, int toIndex) {
    ...
    while (low <= high) {
      ...
      if (midVal.compareTo(v) < 0) low = mid + 1;
      else if (midVal.compareTo(v) > 0) high = mid - 1;
  ...
  public static void main(String[] args) {
    ...
    String[] input =
        new String[] {"this", "you", "input", "assignment", "a", "characters", "code", "composed"};
    for (String s : input) {
