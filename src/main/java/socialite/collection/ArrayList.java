...
public class ArrayList<E> extends AbstractCollection<E>
  ...
  protected transient volatile Object[] elems;
  protected int size;
  ...
  public int indexOf(Object o) {
    if (o == null) {
      for (int i = 0; i < size; i++) if (elems[i] == null) return i;
    } else {
      for (int i = 0; i < size; i++) if (o.equals(elems[i])) return i;
    }
    return -1;
  }
  ...
  void removeReallyAt(int idx) {
    ...
    if (shiftNum > 0) System.arraycopy(elems, idx + 1, elems, idx, shiftNum);
    elems[--size] = null;
  }

  public void clear() {
    for (int i = 0; i < size; i++) elems[i] = null;
    size = 0;
  }
  ...
  public boolean addAll(int idx, Collection<? extends E> c) {
    ...
    if (shiftNum > 0) System.arraycopy(elems, idx, elems, idx + added, shiftNum);
  ...
  private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
    ...
    Object[] tmp = elems;
    for (int i = 0; i < size; i++) s.writeObject(tmp[i]);
  }
  ...
  private void readObject(java.io.ObjectInputStream s)
    ...
    Object[] tmp = elems;
    for (int i = 0; i < size; i++) tmp[i] = s.readObject();
  }
}
